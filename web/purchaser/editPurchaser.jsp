...
<html lang="en-US">
    <head>
        <title>E-Tender: Edit Purchaser</title>
        <meta charset="utf-8">
            ...
            <div class="container">
                <div class="col-md-12">
                    <nav>
                        ...
                        %>
                        <form action="../EditPurchaserBean" class="form-horizontal" method="post" accept-charset="utf-8">
